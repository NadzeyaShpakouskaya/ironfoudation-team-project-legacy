...
### Changed
 ...
 - Update `SitterListView` to present information about loading status and errors if needed - [#218](https://github.com/ios-course/ironfoudation-team-project/pull/218)
