...
- Add new storage keys and names to store preferences and current sitter information  in `KeyValueStorage` - [#109](https://github.com/ios-course/ironfoudation-team-project/pull/109)
